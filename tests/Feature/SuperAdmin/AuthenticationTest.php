...
it('creates a super admin with valid factory', function () {
...
it('creates owner super admin', function () {
...
it('creates support super admin', function () {
...
it('creates inactive super admin', function () {
    $admin = SuperAdmin::factory()->inactive()->create();

    expect($admin->is_active)->toBeFalse();
});

it('creates locked super admin', function () {
...
it('can record successful login', function () {
    $admin = SuperAdmin::factory()->create([
...
it('can record failed login attempt', function () {
    $admin = SuperAdmin::factory()->create([
...
it('locks account after max failed attempts', function () {
    $admin = SuperAdmin::factory()->create([
        'failed_login_attempts' => 2,
    ]);
...
it('logs activity on successful authentication', function () {
    $admin = SuperAdmin::factory()->create();
...
it('super admin has correct role methods', function () {
...
it('can filter active super admins', function () {
...
it('can filter super admins by role', function () {
