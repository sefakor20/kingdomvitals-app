...
>
    ...
    >
        <div class="flex flex-col">
            {{-- Search Input --}}
            <div class="relative">
                <flux:icon icon="magnifying-glass" class="absolute left-4 top-1/2 size-5 -translate-y-1/2 text-zinc-400" />
                <input
                    type="text"
                    x-ref="searchInput"
                                    ...
                                    <div class="space-y-0.5">
                                        @foreach($items as $item)
                                            <button
                                                ...
                                                class="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-left transition hover:bg-zinc-100 focus:bg-zinc-100 focus:outline-none dark:hover:bg-zinc-800 dark:focus:bg-zinc-800"
                                            >
