<section class="w-full">
    ...
    <x-settings.layout :heading="__('Subscription')" :subheading="__('View your current plan and usage limits')">
                ...
                <div class="border-t border-zinc-200 pt-6 dark:border-zinc-700">
                    <div class="flex items-center justify-between">
                        ...
                        @if(Route::has('upgrade.required'))
                            <flux:button variant="primary" href="{{ route('upgrade.required', ['module' => 'subscription']) }}">
                                {{ __('Upgrade Plan') }}
                            </flux:button>
                        @endif
                    </div>
