...
>
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        <div class="mx-auto grid max-w-5xl gap-16 lg:grid-cols-2">
            {{-- Contact Info --}}
            <div>
                <p class="label-mono text-emerald-600 dark:text-emerald-400">Contact Us</p>
                ...
                <dl class="mt-10 space-y-6">
                    ...
                    <div class="flex gap-4">
                        <div class="flex size-12 shrink-0 items-center justify-center rounded-xl bg-emerald-500/10">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-secondary">hello@kingdomvitals.app</dd>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <dd class="mt-1 text-secondary">+233 50 922 8314/+233 54 882 8183</dd>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            <dt class="text-sm font-medium text-primary">Location</dt>
                            <dd class="mt-1 text-secondary">Accra, Ghana</dd>
                        </div>
                    </div>
                </dl>
            </div>
