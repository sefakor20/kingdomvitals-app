...
>
    ...
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="mx-auto mt-16 max-w-5xl sm:mt-20">
            <div
                class="grid gap-4 transition-all duration-700 ease-out delay-200 md:grid-cols-2 lg:grid-cols-3"
                :class="shown ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'"
            >
                {{-- AI Feature 1: Predictive Insights --}}
                <div class="glass-card group relative p-6 transition hover:border-lime-500/40">
