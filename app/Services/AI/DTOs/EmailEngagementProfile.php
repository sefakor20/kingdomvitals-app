...
readonly class EmailEngagementProfile
{
    public function __construct(
        public string $memberId,
        public float $engagementScore,
        public EmailEngagementLevel $engagementLevel,
    ...
    /**
     * Get recommended monthly email count.
     */
    public function recommendedMonthlyEmails(): int
    {
        return $this->engagementLevel->recommendedMonthlyEmails();
    }
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            engagementLevel: EmailEngagementLevel::from($data['engagement_level']),
